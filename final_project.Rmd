...
steelhead_summary <- steelhead |>  group_by(Population, Brood_year) |> summarize(Value = mean(Value), percent_protected = round(mean(percent_protected))) #taking the mean estimation for years where estimate done multiple ways 
